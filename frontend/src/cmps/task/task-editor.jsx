...
export function TaskEditor({onRemoveTask , taskId}) {
    ...
    return (
        <div className="card-editor-buttons">
            <a className="quick-card-editor-buttons-item" href="/c/SVVJv135/2-filter-toys-by-in-stock" data-testid="card-quick-edit-menu-open-card"><span className="icon-sm icon-card light"></span><span className="quick-card-editor-buttons-item-text">Open card</span></a>
            <a className="quick-card-editor-buttons-item js-edit-labels" href="#" data-testid="card-quick-edit-menu-edit-labels"><span className="icon-sm icon-label light"></span><span className="quick-card-editor-buttons-item-text">Edit labels</span></a>
            <a className="quick-card-editor-buttons-item js-edit-members" href="#" data-testid="card-quick-edit-menu-change-members"><span className="icon-sm icon-member light"></span><span className="quick-card-editor-buttons-item-text">Change members</span></a>
            <a className="quick-card-editor-buttons-item js-edit-cover" href="#" data-testid="card-quick-edit-menu-change-cover"><span className="icon-sm icon-card-cover light"></span><span className="quick-card-editor-buttons-item-text">Change cover</span></a>
